...
> No GitHub? Run `npm pack` to produce `anisthesia-claude-broker-2.2.1.tgz` and send them the file; they
> install it with `npm install ./anisthesia-claude-broker-2.2.1.tgz`.
